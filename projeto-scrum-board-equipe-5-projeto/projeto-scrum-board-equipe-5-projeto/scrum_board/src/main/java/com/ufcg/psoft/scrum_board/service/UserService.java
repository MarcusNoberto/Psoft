...
public class UserService {
    ...
    public void deleteUser(String username) throws UserNotFoundException {
        if (!this.userAlreadyExists(username)) throw new UserNotFoundException("The user '" + username + "' doesn't exists! Operation not successed!");
        this.userRep.delUser(username);
    }
