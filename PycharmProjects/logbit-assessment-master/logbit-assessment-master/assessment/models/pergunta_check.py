...
class PerguntaCheck(models.Model):
    """
       Classe PerguntaCheck implementa as funções relacionadas as configurações de perguntas check
    """
    CHOICES = (
        ("SIM", "Sim"),
        ("NAO", "Não"),
    ...
    def save(self, *args, **kwargs):
        ...
        super(PerguntaCheck, self).save(*args, **kwargs)
