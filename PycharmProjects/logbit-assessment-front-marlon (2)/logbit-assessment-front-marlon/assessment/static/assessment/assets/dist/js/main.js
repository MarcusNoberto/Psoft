...
})({"3p1Hm":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "702983e284556c89";
...
},{}],"3Do0m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _accordion = require("./modules/accordion");
var _accordionDefault = parcelHelpers.interopDefault(_accordion);
var _sidebarMenu = require("./modules/sidebarMenu");
var _sidebarMenuDefault = parcelHelpers.interopDefault(_sidebarMenu);
(0, _accordionDefault.default)();
const menu = (0, _sidebarMenuDefault.default)().init();
window.menu = menu;
document.addEventListener("DOMContentLoaded", ()=>document.body.classList.add("DOMContentLoaded"));

},{"./modules/accordion":"fJayl","./modules/sidebarMenu":"28YDs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fJayl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function accordion() {
    ...
    accordions.forEach((a)=>{
        ...
        title.addEventListener("click", ()=>{
            ...
            if (attrParent) document.querySelectorAll(`.accordion-title[js-comentario-parent="${attrParent}"]`).forEach((i)=>{
                console.log(i, title);
                if (i !== title) {
...
},{}],"28YDs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function multiLevelMenu() {
    ...
    const handleAddCurrentPageClass = ()=>{
        ...
        menuItems.forEach((item)=>{
            if (item.getAttribute("js-menu-page") == pageName) item.classList.add("current-page");
        });
    };
    const events = ()=>{
        if (isMobile) toogle?.addEventListener("click", toogleMenu);
        else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3p1Hm","3Do0m"], "3Do0m", "parcelRequireb6c8")
